chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    ...
    } else if (message.action === "sensitiveFormDetected") {
      // Handle sensitive form detection here (e.g., display an alert)
      chrome.notifications.create({
        type: "basic",
        iconUrl: "icon.png", // Your extension icon
        title: "Data Collection Alert!",
        message: "A form with potentially sensitive data was found on this webpage."
      });
    }
  });
